  ...
  return (
    <View style={styles.bigContainer}>
        ...
        <View style={styles.pagiContainer}>
          ...
          <Button
            ...
            onPress={() => {
              if (
                sayfaNo <
                Math.ceil(database['Mide'][4].belirti.length / 5) - 1
              ) {
                setSayfaNo(sayfaNo + 1);
              } else return;
            }}
      ...
      <Button
        ...
        onPress={async () => {
          if (dizi.length > 0) {
            const sonuc = await Karsilastir(dizi, database.Mide);
            setDizi([]);
